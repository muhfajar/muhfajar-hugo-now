...
In each piece of content you can provide variables to be used by the templates. This happens in the [front matter](https://gohugo.io/content-management/front-matter/).
